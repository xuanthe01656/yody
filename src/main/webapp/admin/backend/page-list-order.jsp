            ...
            <div class="col-lg-12">
                <div class="table-responsive rounded mb-3">
                 <div class="row" style="padding-bottom: 10px;">
                 	<div class="col-sm-2" style="padding-right:0; max-width: 10%">
                 		<form action="<%=request.getContextPath()%>/admin/export-excel" method="post">
                    			<button type="submit" name="export" value="export">Export Excel</button>
                    	</form>
                 	</div>
                 	<div class="col-sm-2" style="padding-right:0;">
                 		<form action="<%=request.getContextPath()%>/admin/export-pdf" method="post">
                    			<button type="submit" name="export" value="export">Export PDF</button>
                    	</form>
                 	</div>
                    </div>
                            ...
                            <td>
                            	<select>
                            		<%
                                    	...
                                    	ArrayList<Status> listStatus = objStatusDAO.getItem();
                                    	for(Status status: listStatus){
                            		%>
                            		<option <%if(status.getId()==objOrder.getStatus()){out.print("selected");}; %>><%=status.getStatus_ad() %></option>
                            		<%} %>
                            	</select>
                            </td>
                            <td>
