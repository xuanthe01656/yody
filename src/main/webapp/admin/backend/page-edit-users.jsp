            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <%
                    		...
                    		if(request.getAttribute("objAd")!=null){
                    			objAdmin = (Admin) request.getAttribute("objAd");
                    		}
							%>
                            ...
                            <div class="row"> 
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        <label>Name *</label>
                                        <input type="text" name="fullname" class="form-control" value="<%=objAdmin.getFullname() %>" placeholder="Enter Name" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" class="form-control" value="<%=objAdmin.getPhone() %>" placeholder="Enter Phone No" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div> 
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Email *</label>
                                        <input type="text" id="emailU" name="email" class="form-control" value="<%=objAdmin.getEmail() %>" placeholder="Enter Email" required>
                                ...
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="usernameU" name="username" value="<%=objAdmin.getUsername() %>" class="form-control" placeholder="Enter User Name">
                                ...
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="password" class="form-control" value="<%=objAdmin.getPassword() %>" placeholder="Enter Password" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>   
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        %>
                                            <option <%if(objAdmin.getPosition_id()==objPs.getId()){out.print("selected");}; %> value="<%=objPs.getId()%>"><%=objPs.getPosition() %></option>
                                            <%}} %>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Position Detail</label>
                                       	<input type="text" name="position_detail" class="form-control" value="<%=objAdmin.getPosition_detail() %>" placeholder="Enter Position Detail" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>           
                            </div>                            
