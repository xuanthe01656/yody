                              ...
                              <div class="chat-search pt-3 pl-3">
                                 <div class="d-flex align-items-center">
                                    <div class="chat-profile mr-3">
                                       <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/1.jpg" alt="chat-user" class="avatar-60 ">
                                    </div>
                                 ...
                                 <div id="user-detail-popup" class="scroller">
                                    <div class="user-profile">
                                       ...
                                       <div class="user text-center mb-4">
                                          <a class="avatar m-0">
                                             <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/1.jpg" class="avatar-100" alt="avatar">
                                          </a>
                                 ...
                                 <ul class="iq-chat-ui nav flex-column nav-pills">
                                       ...
                                       <a data-toggle="pill" href="#chatbox1">
                                          <div class="d-flex align-items-center">
                                             <div class="avatar mr-2">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/05.jpg" alt="chatuserimage"
                                                   class="avatar-50 ">
                                    ...
                                    <li>
                                       <a data-toggle="pill" href="#chatbox2">
                                          <div class="d-flex align-items-center">
                                             <div class="avatar mr-2">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/06.jpg" alt="chatuserimage"
                                                   class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                 ...
                                 <ul class="iq-chat-ui nav flex-column nav-pills">
                                    <li>
                                       <a data-toggle="pill" href="#chatbox3">
                                          <div class="d-flex align-items-center">
                                             <div class="avatar mr-2">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/07.jpg" alt="chatuserimage"
                                                   class="avatar-50 ">
                                                <span class="avatar-status"><i
                                    ...
                                    <li>
                                       <a data-toggle="pill" href="#chatbox4">
                                          <div class="d-flex align-items-center">
                                             <div class="avatar mr-2">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/08.jpg" alt="chatuserimage"
                                                   class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                    ...
                                    <li>
                                       <a data-toggle="pill" href="#chatbox5">
                                          <div class="d-flex align-items-center">
                                             <div class="avatar mr-2">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/09.jpg" alt="chatuserimage"
                                                   class="avatar-50 ">
                                                <span class="avatar-status"><i
                                 ...
                                 <ul class="iq-chat-ui nav flex-column nav-pills">
                                    <li>
                                       <a data-toggle="pill" href="#chatbox6">
                                          <div class="d-flex align-items-center">
                                             <div class="avatar mr-2">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/10.jpg" alt="chatuserimage"
                                                   class="avatar-50 ">
                                                <span class="avatar-status"><i
                                 ...
                                 <div class="tab-pane fade" id="chatbox1" role="tabpanel">
                                       ...
                                       <header
                                          ...
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="avatar chat-user-profile m-0 mr-3">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/05.jpg" alt="avatar" class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                          ...
                                          <div class="chat-user-detail-popup scroller">
                                             <div class="user-profile text-center">
                                                ...
                                                <div class="user mb-4">
                                                   <a class="avatar m-0">
                                                      <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/05.jpg" class="avatar-100" alt="avatar">
                                                   </a>
                                                   <div class="user-name mt-4">
                                                      <h4>Bni Jordan</h4>
                                                   </div>
                                    ...
                                    <div class="chat-content scroller">
                                       <div class="chat">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/1.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                       ...
                                       <div class="chat chat-left">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/05.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                       ...
                                       <div class="chat">
                                          ...
                                          <div class="chat-detail">
                                             <div class="chat-message">
                                                <p>Absolutely!</p>
                                                <p>YODY Dashboard is the responsive bootstrap 4 admin template.</p>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="chat chat-left">
                                 ...
                                 <div class="tab-pane fade" id="chatbox2" role="tabpanel">
                                    <div class="chat-head">
                                       <header
                                          ...
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="avatar chat-user-profile m-0 mr-3">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/06.jpg" alt="avatar" class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                          ...
                                          <div class="chat-user-detail-popup scroller">
                                             <div class="user-profile text-center">
                                                ...
                                                <div class="user mb-4">
                                                   <a class="avatar m-0">
                                                      <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/06.jpg" class="avatar-100" alt="avatar">
                                                   </a>
                                                   <div class="user-name mt-4">
                                                      <h4>Mark Jordan</h4>
                                                   </div>
                                    ...
                                    <div class="chat-content scroller">
                                       ...
                                       <div class="chat chat-left">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/06.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                             <span class="chat-time mt-1">6:48</span>
                                          </div>
                                          <div class="chat-detail">
                                 ...
                                 <div class="tab-pane fade" id="chatbox3" role="tabpanel">
                                    <div class="chat-head">
                                       <header
                                          ...
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="avatar chat-user-profile m-0 mr-3">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/07.jpg" alt="avatar" class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                          ...
                                          <div class="chat-user-detail-popup scroller">
                                             <div class="user-profile text-center">
                                                ...
                                                <div class="user mb-4">
                                                   <a class="avatar m-0">
                                                      <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/07.jpg" class="avatar-100" alt="avatar">
                                                   </a>
                                                   <div class="user-name mt-4">
                                                      <h4>Paige Turner</h4>
                                                   </div>
                                    ...
                                    <div class="chat-content scroller">
                                       ...
                                       <div class="chat chat-left">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/07.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                             <span class="chat-time mt-1">6:48</span>
                                          </div>
                                          <div class="chat-detail">
                                 ...
                                 <div class="tab-pane fade" id="chatbox4" role="tabpanel">
                                    <div class="chat-head">
                                       <header
                                          ...
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="avatar chat-user-profile m-0 mr-3">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/08.jpg" alt="avatar" class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                          ...
                                          <div class="chat-user-detail-popup scroller">
                                             <div class="user-profile text-center">
                                                ...
                                                <div class="user mb-4">
                                                   <a class="avatar m-0">
                                                      <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/08.jpg" class="avatar-100" alt="avatar">
                                                   </a>
                                                   <div class="user-name mt-4">
                                                      <h4>Barb Ackue</h4>
                                                   </div>
                                    ...
                                    <div class="chat-content scroller">
                                       ...
                                       <div class="chat chat-left">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/08.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                             <span class="chat-time mt-1">6:48</span>
                                          </div>
                                          <div class="chat-detail">
                                 ...
                                 <div class="tab-pane fade" id="chatbox5" role="tabpanel">
                                    <div class="chat-head">
                                       <header
                                          ...
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="avatar chat-user-profile m-0 mr-3">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/09.jpg" alt="avatar" class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                          ...
                                          <div class="chat-user-detail-popup scroller">
                                             <div class="user-profile text-center">
                                                ...
                                                <div class="user mb-4">
                                                   <a class="avatar m-0">
                                                      <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/09.jpg" class="avatar-100" alt="avatar">
                                                   </a>
                                                   <div class="user-name mt-4">
                                                      <h4>Peta Saireya</h4>
                                                   </div>
                                    ...
                                    <div class="chat-content scroller">
                                       ...
                                       <div class="chat chat-left">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/09.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                             <span class="chat-time mt-1">6:48</span>
                                          </div>
                                          <div class="chat-detail">
                                 ...
                                 <div class="tab-pane fade" id="chatbox6" role="tabpanel">
                                    <div class="chat-head">
                                       <header
                                          ...
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="avatar chat-user-profile m-0 mr-3">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/10.jpg" alt="avatar" class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                          ...
                                          <div class="chat-user-detail-popup scroller">
                                             <div class="user-profile text-center">
                                                ...
                                                <div class="user mb-4">
                                                   <a class="avatar m-0">
                                                      <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/10.jpg" class="avatar-100" alt="avatar">
                                                   </a>
                                                   <div class="user-name mt-4">
                                                      <h4>Paul Molive</h4>
                                                   </div>
                                    ...
                                    <div class="chat-content scroller">
                                       ...
                                       <div class="chat chat-left">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="<%=request.getContextPath() %>/templates/admin/assets/images/user/10.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                             <span class="chat-time mt-1">6:48</span>
                                          </div>
                                          <div class="chat-detail">
