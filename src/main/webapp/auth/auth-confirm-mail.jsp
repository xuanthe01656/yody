                     ...
                     <div class="card-body p-0">
                        <div class="d-flex align-items-center auth-content">
                           <div class="col-lg-7 align-self-center">
                              <div class="p-3">
                                 <img src="<%=request.getContextPath() %>/templates/admin/assets/images/login/mail.png" class="img-fluid" width="80" alt="">
                                 ...
                                 <div class="d-inline-block w-100">
                                    <a href="<%=request.getContextPath() %>/templates/admin/backend/index.jsp" class="btn btn-primary mt-3">Back to Home</a>
                                 </div>
                              </div>
                           </div>
