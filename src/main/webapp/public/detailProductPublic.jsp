            ...
            <div class="cms_banner mt_50">
              <div class="col-sm-12 mt_10">
                ...
                if(request.getAttribute("listPro")!=null){
                	...
                	String images = "";
                	String color = "";
                if(request.getAttribute("objPl")!=null){
                	DisplayPublic objPl = (DisplayPublic) request.getAttribute("objPl");
                %>
                  <div class="sub-img">
                  <%
                  	if(objPl.getImg_detail()!=null){
                  		String applicationPath = request.getServletContext().getRealPath("");
    					String path = request.getServletContext().getRealPath("/templates/admin/assets/images/table/imgpublic/");
    					File image = new File(path+objPl.getImg_detail());
    					if(image.exists()){
                  %>
                  	<img src="<%=request.getContextPath() %>/templates/admin/assets/images/table/imgpublic/<%=objPl.getImg_detail() %>" alt="Sub Banner3" class="img-responsive">
                  <%}} %>
                  </div>
                </div>
              </div>
				...
				<div class="row">
					<div class="col-12 a-left">
						<ul class="breadcrumb">
							...
							<li class="last">
								<strong><span> <%=objPl.getDetail() %></span></strong>
							</li>
						</ul>
					</div>
					<%} %>
								...
								<script>
			                		$('#size<%=objsize.getId() %>').on('click', function(){
			                			...
			                			if(this.checked){
				                			...
				                			var menu = '<%=listPro1.get(0).getMenu()%>';
				                			$.ajax({	
        ...
        <div class="col-sm-8 col-lg-9 mt_50 ajax-show-filter-product">
            <div class="row">
                  <%
                      ...
                      %>
                            <div class="col-sm-2 col-lg-3 mb_20">
                              ...
                              %>
                                 		<div class="col-lg-3" style="padding-right: 0px; width: 40px;">
                                 			<img id="img-icon<%=objPr1.getProductSKU() %><%=j %>" src="<%=request.getContextPath() %>/templates/admin/assets/images/table/product/<%=image_list[j] %>" class="img-fluid rounded avatar-50 mr-3 img-icon" style="width: 30px; height: 30px; border-radius: 30px;" alt="image" title="<%=color_list[j]%>">
                                 		</div>
                    	...
                    	<div class="row">
                            	<%
    								...
    								if(request.getAttribute("index")!=null){
										...
										int numPage = objPro.getNumberPageProPS();
                                ...
                                <div class="col-sm-8" style="text-align: right; margin:27px 0px">
                                    <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                                        ...
                                        <ul class="pagination justify-content-end">
                                        	...
                                        	if(index>1){
                                        	%>
                                        	<li class="page-item previous" aria-controls="dataTables-example" tabindex="0" id="dataTables-example_previous"><a class="page-link" href="<%=request.getContextPath()%>/public/show-more-product?index=1">Về trang 1</a></li>
                                            <li class="page-item previous" aria-controls="dataTables-example" tabindex="0" id="dataTables-example_previous"><a class="page-link" href="<%=request.getContextPath()%>/public/show-more-product?index=<%=index-1%>">Trang trước</a></li>
                                            <%} %>
                                            ...
                                            <% 
                                            	if(number_page<numPage ){
                                            		if(numcur<=numPage){                                            			
                                                        ...
                                                        <li class="page-item <%if(i==index){%><%=atc %><%} %> " aria-controls="dataTables-example" tabindex="0"><a class="page-link" href="<%=request.getContextPath()%>/public/show-more-product?index=<%=i%>"><%=i %></a></li>
                                                        <%}
                                            		}else{
                                            ...
                                            %>
                                            <li class="page-item next" aria-controls="dataTables-example" tabindex="0" id="dataTables-example_next"><a class="page-link" href="<%=request.getContextPath()%>/public/show-more-product?index=<%=index+1%>">Trang tiếp</a></li>
                                            <li class="page-item next" aria-controls="dataTables-example" tabindex="0" id="dataTables-example_next"><a class="page-link" href="<%=request.getContextPath()%>/public/show-more-product?index=<%=numPage%>">Đến trang cuối</a></li>
                                            <%} %>
                                        	<%} %>
                                        </ul>
                                    </div>
