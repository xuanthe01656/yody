    ...
    <div class="container">
      <div class="row ">
        ...
        <div class="col-sm-12">
          <div class="breadcrumb ptb_20">
            ...
            <ul>
              ...
              <li><a href="category_page.jsp">Products</a></li>
            ...
            <div id="left-special" class="owl-carousel">
              <ul class="row ">
                <li class="item product-layout-left mb_20">
                  <div class="product-list col-xs-4">
                    <div class="product-thumb">
                      <div class="image product-imageblock"> <a href="<%=request.getContextPath() %>/public/product_detail_page.jsp"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product3.jpg"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product3-1.jpg"> </a> </div>
                    </div>
                  </div>
                  <div class="col-xs-8">
                    <div class="caption product-detail">
                      ...
                      <span class="price"><span class="amount"><span class="currencySymbol">VND</span>70.00</span>
                      </span>
                    </div>
                  </div>
                </li>
                <li class="item product-layout-left mb_20">
                  <div class="product-list col-xs-4">
                    <div class="product-thumb">
                      <div class="image product-imageblock"> <a href="<%=request.getContextPath() %>/public/product_detail_page.jsp"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product4.jpg"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product4-1.jpg"> </a> </div>
                    </div>
                  </div>
                  <div class="col-xs-8">
                    <div class="caption product-detail">
                ...
                <li class="item product-layout-left mb_20">
                  <div class="product-list col-xs-4">
                    <div class="product-thumb">
                      <div class="image product-imageblock"> <a href="<%=request.getContextPath() %>/public/product_detail_page.jsp"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product5.jpg"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product5-1.jpg"> </a> </div>
                    </div>
                  </div>
                  <div class="col-xs-8">
                    <div class="caption product-detail">
              ...
              <ul class="row ">
                <li class="item product-layout-left mb_20">
                  <div class="product-list col-xs-4">
                    <div class="product-thumb">
                      <div class="image product-imageblock"> <a href="<%=request.getContextPath() %>/public/product_detail_page.jsp"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product6.jpg"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product6-1.jpg"> </a> </div>
                    </div>
                  </div>
                  <div class="col-xs-8">
                    <div class="caption product-detail">
                ...
                <li class="item product-layout-left mb_20">
                  <div class="product-list col-xs-4">
                    <div class="product-thumb">
                      <div class="image product-imageblock"> <a href="<%=request.getContextPath() %>/public/product_detail_page.jsp"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product7.jpg"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product7-1.jpg"> </a> </div>
                    </div>
                  </div>
                  <div class="col-xs-8">
                    <div class="caption product-detail">
                ...
                <li class="item product-layout-left mb_20">
                  <div class="product-list col-xs-4">
                    <div class="product-thumb">
                      <div class="image product-imageblock"> <a href="<%=request.getContextPath() %>/public/product_detail_page.jsp"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product8.jpg"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product8-1.jpg"> </a> </div>
                    </div>
                  </div>
                  <div class="col-xs-8">
                    <div class="caption product-detail">
              ...
              <ul class="row ">
                <li class="item product-layout-left mb_20">
                  <div class="product-list col-xs-4">
                    <div class="product-thumb">
                      <div class="image product-imageblock"> <a href="<%=request.getContextPath() %>/public/product_detail_page.jsp"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product9.jpg"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product9-1.jpg"> </a> </div>
                    </div>
                  </div>
                  <div class="col-xs-8">
                    <div class="caption product-detail">
                ...
                <li class="item product-layout-left mb_20">
                  <div class="product-list col-xs-4">
                    <div class="product-thumb">
                      <div class="image product-imageblock"> <a href="<%=request.getContextPath() %>/public/product_detail_page.jsp"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product10.jpg"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product10-1.jpg"> </a> </div>
                    </div>
                  </div>
                  <div class="col-xs-8">
                    <div class="caption product-detail">
                ...
                <li class="item product-layout-left mb_20">
                  <div class="product-list col-xs-4">
                    <div class="product-thumb">
                      <div class="image product-imageblock"> <a href="<%=request.getContextPath() %>/public/product_detail_page.jsp"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product1.jpg"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product1-1.jpg"> </a> </div>
                    </div>
                  </div>
                  <div class="col-xs-8">
                    <div class="caption product-detail">
              ...
              <ul class="row ">
                <li class="item product-layout-left mb_20">
                  <div class="product-list col-xs-4">
                    <div class="product-thumb">
                      <div class="image product-imageblock"> <a href="<%=request.getContextPath() %>/public/product_detail_page.jsp"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product2.jpg"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product2-1.jpg"> </a> </div>
                    </div>
                  </div>
                  <div class="col-xs-8">
                    <div class="caption product-detail">
                ...
                <li class="item product-layout-left mb_20">
                  <div class="product-list col-xs-4">
                    <div class="product-thumb">
                      <div class="image product-imageblock"> <a href="<%=request.getContextPath() %>/public/product_detail_page.jsp"> <img class="<%=request.getContextPath() %>/templates/public/assets/img-responsive" title="iPod Classic" alt="iPod Classic" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product3.jpg"> <img class="img-responsive" title="iPod Classic" alt="iPod Classic" src="images/product/product3-1.jpg"> </a> </div>
                    </div>
                  </div>
                  <div class="col-xs-8">
                    <div class="caption product-detail">
        ...
        <div class="col-sm-8 col-lg-9 mtb_20">
          <div class="row mt_10 ">
            <div class="col-md-6">
              <div><a class="thumbnails"> <img data-name="product_image" src="<%=request.getContextPath() %>/templates/public/assets/images/product/product1.jpg" alt="" /></a></div>
              <div id="product-thumbnail" class="owl-carousel">
                <div class="item">
                  <div class="image-additional"><a class="thumbnail" href="<%=request.getContextPath() %>/templates/public/assets/images/product/product1.jpg" data-fancybox="group1"> <img src="<%=request.getContextPath() %>/templates/public/assets/images/product/product1.jpg" alt="" /></a></div>
                </div>
                <div class="item">
                  <div class="image-additional"><a class="thumbnail" href="<%=request.getContextPath() %>/templates/public/assets/images/product/product2.jpg" data-fancybox="group1"> <img src="<%=request.getContextPath() %>/templates/public/assets/images/product/product2.jpg" alt="" /></a></div>
                </div>
                <div class="item">
                  <div class="image-additional"><a class="thumbnail" href="<%=request.getContextPath() %>/templates/public/assets/images/product/product3.jpg" data-fancybox="group1"> <img src="<%=request.getContextPath() %>/templates/public/assets/images/product/product3.jpg" alt="" /></a></div>
                </div>
                <div class="item">
                  <div class="image-additional"><a class="thumbnail" href="<%=request.getContextPath() %>/templates/public/assets/images/product/product4.jpg" data-fancybox="group1"> <img src="<%=request.getContextPath() %>/templates/public/assets/images/product/product4.jpg" alt="" /></a></div>
                </div>
                <div class="item">
                  <div class="image-additional"><a class="thumbnail" href="<%=request.getContextPath() %>/templates/public/assets/images/product/product5.jpg" data-fancybox="group1"> <img src="<%=request.getContextPath() %>/templates/public/assets/images/product/product5.jpg" alt="" /></a></div>
                </div>
                <div class="item">
                  <div class="image-additional"><a class="thumbnail" href="<%=request.getContextPath() %>/templates/public/assets/images/product/product6.jpg" data-fancybox="group1"> <img src="<%=request.getContextPath() %>/templates/public/assets/images/product/product6.jpg" alt="" /></a></div>
                </div>
                <div class="item">
                  <div class="image-additional"><a class="thumbnail" href="<%=request.getContextPath() %>/templates/public/assets/images/product/product7.jpg" data-fancybox="group1"> <img src="<%=request.getContextPath() %>/templates/public/assets/images/product/product7.jpg" alt="" /></a></div>
                </div>
              </div>
            </div>
            <div class="col-md-6 prodetail caption product-thumb">
              ...
              <span class="price mb_20"><span class="amount"><span class="currencySymbol">VND</span>70.00</span>
              </span>
              <hr>
